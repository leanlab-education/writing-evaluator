...
- [ ] **Rubric editing UI**: Add an admin flow to create/edit/import a project-specific rubric in the UI so future users can configure criteria and answer options without code changes
